...
public class ComplicatedRoute extends RouteBuilder {
    ...
    public void configure() {
        ...
        ComponentsBuilderFactory.kafka()
                ...
                .register(getContext(), "localkafka");
